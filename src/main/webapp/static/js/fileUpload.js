...
var uploadTools = {
    ...
    "initWithLayout":function(opt){
        ...
        btsStr += "<div style='float:left;margin-right:15px;'>";
        btsStr += "<div class='selectFileBt btn btn-info'>选择文件</div>";
        btsStr += "</div>";
        btsStr += "<div class='uploadFileBt'>";
        btsStr += "<i style='font-size:35px;' class='fa fa-cloud-upload'></i>";
        btsStr += " </div>";
        btsStr += "</div>";
